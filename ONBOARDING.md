...
AgentMaster is a skill installer and meta-orchestrator for Claude Code. It installs 44+ skills from five repos into `~/.claude/skills/`, keeps them synced, and routes tasks to the right skill combination via `/agent-master`.
