---
name: agent-master
description: "Meta-orchestrator that classifies tasks and routes to the right combination of installed skills across caveman (output compression), superpowers (dev workflow), and claude-skills (domain expertise). 24 routing categories including whole-codebase analysis via repomix-pack, LLM/AI app dev, and a live task dashboard. Invoke with /agent-master. Use as default entry point for ambiguous or multi-domain requests."
---
