# RULES.example.md — AgentMaster Rules Template

> **How to use:**
> 1. Copy this file: `cp RULES.example.md ~/.claude/RULES.md` (global) or keep as `RULES.md` in your project root (project-level)
> 2. Replace all `[PLACEHOLDERS]` with your actual values
> 3. Delete sections you don't need, add your own
> 4. AgentMaster reads `RULES.md` from the repo root at session start — rules apply automatically
>
> **Scope:**
> - `~/.claude/RULES.md` → applies to ALL sessions globally
> - `<repo-root>/RULES.md` → applies only when working in that repo (loaded by AgentMaster bootstrap)
...
- Full tool/tech reference: `[PATH_TO_AGENTMASTER]/Tool-Stack-Reference/hub/` (62 files, 1524 tools + 1767 tech, free-first)
...
- Main projects dir: [YOUR_PROJECTS_DIR]
  # Examples:
  #   Linux/Mac: ~/projects/  or  /home/yourname/code/
  #   Windows:   D:/Coding/   or  C:/Users/yourname/projects/
- Skills dir: [YOUR_HOME]/.claude/skills/
  # Examples:
